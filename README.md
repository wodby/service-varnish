# Varnish service for Wodby

Use Varnish as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Varnish service in the Wodby catalog.

- [Varnish service in the Wodby catalog](https://wodby.com/services/varnish)
...
4. Reference `varnish` from your stack manifest.
